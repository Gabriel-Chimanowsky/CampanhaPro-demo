import{o as e}from"./AuthContext-C98MDF2j.js";var t=async()=>{let{data:{session:t}}=await e.auth.getSession(),n=t?.access_token;return{"Content-Type":`application/json`,...n?{Authorization:`Bearer ${n}`}:{}}},n=`
